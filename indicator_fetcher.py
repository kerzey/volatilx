...
# class TradingViewIndicatorFetcher:
#     def __init__(self):
#         """
#         Initialize the TradingView Indicator Fetcher
#         Note: This uses the tradingview-ta library which doesn't require direct authentication
#         """
#         self.session = requests.Session()
    
#     def get_technical_analysis(self, symbol: str, exchange: str = "NASDAQ", 
#                              interval: str = "1d") -> Dict:
#         """
#         Fetch technical analysis indicators for a specific symbol
...
#         """
#         try:
#             # Map string intervals to Interval enum
#             interval_map = {
...
#             handler = TA_Handler(
#                 symbol=symbol,
#                 screener="america",  # or "forex", "crypto"
#                 exchange=exchange,
...
#     def get_multiple_indicators(self, symbols: List[str], exchange: str = "NASDAQ", 
...
#         Returns:
#             List of dictionaries containing technical indicators
#         """
#         results = []
        
#         for symbol in symbols:
#             print(f"Fetching data for {symbol}...")
#             data = self.get_technical_analysis(symbol, exchange, interval)
#             if data:
#                 results.append(data)
...
#     def get_specific_indicators(self, symbol: str, exchange: str = "NASDAQ", 
#                               interval: str = "1d", 
#                               indicator_list: List[str] = None) -> Dict:
#         """
#         Fetch specific indicators for a symbol
        
#         Args:
#             symbol: Trading symbol
#             exchange: Exchange name
#             interval: Time interval
#             indicator_list: List of specific indicators to fetch
        
#         Returns:
#             Dictionary containing requested indicators
#         """
#         analysis_data = self.get_technical_analysis(symbol, exchange, interval)
        
#         if not analysis_data or not indicator_list:
...
#                 filtered_indicators[indicator] = all_indicators[indicator]
        
#         return {
#             'symbol': symbol,
#             'exchange': exchange,
#             'interval': interval,
#             'requested_indicators': filtered_indicators
#         }

# # # Usage Examples
# def main():
#     # Initialize the fetcher
#     fetcher = TradingViewIndicatorFetcher()
    
#     # Example 1: Get all indicators for a single symbol
#     print("=== Single Symbol Analysis ===")
#     aapl_data = fetcher.get_technical_analysis("AAPL", "NASDAQ", "1d")
#     if aapl_data:
#         print(f"Summary for AAPL: {aapl_data['summary']}")
#         print(f"Available indicators: {list(aapl_data['indicators'].keys())}")
    
#     # Example 2: Get indicators for multiple symbols
#     print("\n=== Multiple Symbols Analysis ===")
#     symbols = ["AAPL", "GOOGL", "MSFT", "TSLA"]
#     multi_data = fetcher.get_multiple_indicators(symbols, "NASDAQ", "1d")
    
#     for data in multi_data:
#         print(f"{data['symbol']}: {data['summary']['RECOMMENDATION']}")
    
#     # Example 3: Get specific indicators
#     print("\n=== Specific Indicators ===")
#     specific_indicators = [
#         "RSI", "MACD.macd", "MACD.signal", "BB.upper", "BB.lower", 
#         "SMA10", "SMA20", "EMA10", "EMA20", "Stoch.K", "Stoch.D"
#     ]
    
#     specific_data = fetcher.get_specific_indicators(
#         "AAPL", "NASDAQ", "1d", specific_indicators
#     )
    
#     if specific_data:
#         print("Specific indicators for AAPL:")
#         for indicator, value in specific_data['requested_indicators'].items():
#             print(f"  {indicator}: {value}")

# if __name__ == "__main__":
#     main()
# # Code Generated by Sidekick is for learning and experimentation purposes only.
# class AdvancedTradingViewFetcher(TradingViewIndicatorFetcher):
#     def __init__(self):
#         super().__init__()
#         self.common_indicators = [
#             "RSI", "MACD.macd", "MACD.signal", "BB.upper", "BB.lower",
#             "SMA10", "SMA20", "SMA50", "SMA200", "EMA10", "EMA20", 
#             "EMA50", "EMA200", "Stoch.K", "Stoch.D", "ADX", "Williams %R",
#             "CCI20", "ATR", "highs", "lows", "close"
#         ]
    
#     def create_watchlist_report(self, watchlist: Dict[str, List[str]], 
#                                interval: str = "1d") -> Dict:
#         """
#         Create a comprehensive report for a watchlist organized by exchanges
        
#         Args:
#             watchlist: Dictionary with exchange as key and list of symbols as value
#             interval: Time interval
...
#             for symbol in symbols:
#                 data = self.get_specific_indicators(
#                     symbol, exchange, interval, self.common_indicators
#                 )
#                 if data:
#                     exchange_data.append(data)
#                 time.sleep(0.5)  # Rate limiting
            
#             report['exchanges'][exchange] = exchange_data
...
#     fetcher = AdvancedTradingViewFetcher()
    
#     # Define your watchlist
#     my_watchlist = {
#         "NASDAQ": ["AAPL", "GOOGL", "MSFT", "TSLA", "AMZN"],
#         "NYSE": ["JPM", "BAC", "WMT", "JNJ"],
#         "BINANCE": ["BTCUSDT", "ETHUSDT", "ADAUSDT"]  # For crypto
#     }
    
#     # Generate comprehensive report
#     report = fetcher.create_watchlist_report(my_watchlist, "1h")
    
#     # Export to JSON
#     fetcher.export_to_json(report, "trading_indicators_report.json")
...
#     print("🎯 MULTI-TIMEFRAME TECHNICAL ANALYSIS SYSTEM")
#     print("=" * 60)
    
#     # Show interval limits
#     compare_intervals_demo()
    
#     print("\n" + "=" * 60)
    
#     # Test data fetching
#     test_different_intervals('TQQQ')
    
#     print("\n" + "=" * 60)
    
#     # Run quick analysis
#     quick_analysis('TQQQ', timeframes=['5m', '15m', '1h', '1d'])
...
#     symbols = ['SPY', 'DUOL', 'ASML',"AMD","LULU","INTC","ADBE"]
    
#     for symbol in symbols:
#         try:
#             analysis = analyzer.analyze_symbol(symbol, period="6mo")
#             if analysis:
...
# def plot_fibonacci_and_waves(symbol, period="6mo"):
#     """Plot price with Fibonacci levels and wave analysis"""
#     analyzer = ComprehensiveTechnicalAnalyzer()
#     analysis = analyzer.analyze_symbol(symbol, period)
...
#     fib = analysis['fibonacci_analysis']
#     for level, price_data in fib['key_levels'].items():
#         plt.axhline(y=price_data, color='red', linestyle='--', alpha=0.7, label=f'Fib {level}')
    
#     plt.title(f'{symbol} - Price with Fibonacci Levels')
#     plt.legend()
...
#     # Optional: Create plots (requires matplotlib)
#     # plot_fibonacci_and_waves('AAPL')



# # Usage example
# def main():
#     fetcher = ComprehensiveIndicatorFetcher()
    
#     symbols = ['SPY', 'DUOL', 'ASML',"AMD","NVDA","TSLA","AMZN","META","LULU","INTC","ADBE"]
    
#     for symbol in symbols:
#         print(f"\n=== {symbol} Analysis ===")
#         data = fetcher.get_all_indicators(symbol)
...
#             # Wavetrend
#             if 'error' not in data['indicators']['Wavetrend']:
#                 wt = data['indicators']['Wavetrend']
#                 print(f"Wavetrend: WT1={wt['wt1']:.2f} | WT2={wt['wt2']:.2f} | Cross: {wt['cross']}")
            
#             # Fibonacci
#             fib = data['indicators']['Fibonacci']
#             print(f"Fibonacci 50%: ${fib['levels']['50%']:.2f} | 61.8%: ${fib['levels']['61.8%']:.2f}")
