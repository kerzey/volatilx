export type ReportPlanSwitcherProps = {
  options: Array<{
    symbol: string;
...
export function ReportPlanSwitcher({ options, activeSymbol, onSelect }: ReportPlanSwitcherProps) {
  if (!options.length) {
    return null;
  }
        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              title={option.generatedDisplay ? `Generated ${option.generatedDisplay}` : undefined}
