...
PLAN_DEFINITIONS: List[PlanDefinition] = [
    ...
    PlanDefinition(
        ...
        description="Entry plan with 60 AI strategy runs per billing cycle.",
    ),
    PlanDefinition(
        slug="sigma",
        name="Sigma",
        monthly_price_cents=4499,
        ai_runs_included=130,
        stripe_price_id="price_1SSjWzC0H4HP0kcQmAYFjXwn",
        description="Balanced tier for active traders with 130 AI runs each month.",
    ),
    PlanDefinition(
        slug="omega",
        name="Omega",
        monthly_price_cents=8999,
        ai_runs_included=300,
        stripe_price_id="price_1SSjXfC0H4HP0kcQxtPM9WuD",
        description="Advanced plan unlocking 300 AI runs and priority processing.",
    ),
]
