...
class LivePriceStream:
    ...
    def __init__(
        ...
        *,
        ...
        self._api_key = api_key or os.getenv("ALPACA_API_KEY") or os.getenv("APCA_API_KEY_ID")
        self._api_secret = api_secret or os.getenv("ALPACA_API_SECRET_KEY") or os.getenv("APCA_API_SECRET_KEY")
